...
const applyConfigAndroid = (config, identifier) => ({
	...
	expo: {
		...
		android: {
			...
			adaptiveIcon: {...configAndroid.adaptiveIcon, foregroundImage: `./assets/${config.expo.extra.logo}/adaptive-icon.png`,},
		},
		extra: {
			...config.expo.extra,
			version, 
...
module.exports = () => {
	...
	switch (process.env.APP_ENV) {
			...
			// 	return applyConfigAndroid(config_file_second, Identifier.second);

			// case 'IOS':

			// 	return applyConfigIos(config_file_second, Identifier.second);
	}
}